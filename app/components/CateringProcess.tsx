  ...
  return (
    <section className="py-24 px-6 bg-[#FFF9F2]" style={{ fontFamily: "'Comic Neue', cursive" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="bg-white border-4 border-[#333333] p-8 rounded-[2.5rem] shadow-[10px_10px_0px_#333333] text-center flex-1 hover:translate-y-[-10px] transition-transform group">
        ...
        <div className="mt-20 bg-white border-4 border-[#333333] rounded-[2rem] p-6 flex flex-col md:flex-row items-center justify-center gap-6 shadow-[8px_8px_0px_#F26522]">
